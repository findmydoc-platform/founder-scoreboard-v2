...
async function main() {
  ...
  console.log(
    `Draft or adjust the final German Google Chat message, then send it with: node .agents/skills/fmd-release-publish/scripts/send-google-chat-message.mjs --release-tag ${releasePlan.nextTag} --message-file <path> --yes`,
  );
}
