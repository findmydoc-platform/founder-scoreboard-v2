...
description: Use only when creating, reviewing, applying, squashing, or verifying this repository's Supabase migrations, RLS policies, grants, indexes, storage configuration, or migration-ledger repairs. Prefer additive timestamp migrations and ask before destructive database changes.
---
