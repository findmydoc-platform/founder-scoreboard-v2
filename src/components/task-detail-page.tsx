...
import { TaskBlockerCard } from "@/components/task-blocker-card";
import { TaskBriefSection } from "@/components/task-brief-section";
import { TaskContextSection } from "@/components/task-context-section";
...
import { buildDetailsMilestonePatch, buildDetailsPackagePatch, buildEditableTaskState, buildTaskBriefDraft, buildTaskDetailGitHubState, buildTaskDetailsDraft, buildTaskDetailViewModel } from "@/lib/task-detail-state";
import { useTaskComments } from "@/hooks/use-task-comments";
import { useTaskRelationships } from "@/hooks/use-task-relationships";
import type { EditableTaskState } from "@/lib/task-detail-state";
