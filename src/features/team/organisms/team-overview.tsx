...
export function TeamOverview({
  ...
  teamWorkweekStarterEnabled: boolean;
  ...
  return (
    <div className="grid gap-4">
      ...
      {teamWorkweekStarterEnabled && actualProfile && (
        <PrivateTeamWorkweekCard apiClient={apiClient} profile={actualProfile} />
      )}

      {teamWorkweekStarterEnabled && <PublishedTeamWorkweeksCard apiClient={apiClient} profiles={data.profiles} />}
