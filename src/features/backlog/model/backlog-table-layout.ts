export const backlogTableMinWidth = 980;
export const backlogTableMinWidthClass = "min-w-[980px]";
export const backlogSkeletonGridClassName = "grid-cols-[48px_48px_2fr_120px_1.4fr_120px_100px_90px_130px_110px]";
...
export const backlogTableColumns = [
  ...
  { id: "effort", label: "Aufwand", skeletonWidth: "w-16" },
