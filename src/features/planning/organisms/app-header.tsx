...
export function AppHeader({
  ...
  return (
    <header className="relative z-20 border-b border-slate-200 bg-white/95 backdrop-blur lg:sticky lg:top-0">
      {notices}
      {compact ? (
        ...
        <div className="flex flex-wrap items-start justify-between gap-3 px-4 py-3 sm:gap-4 sm:px-5 sm:py-5 lg:flex-nowrap lg:items-center lg:px-8">
