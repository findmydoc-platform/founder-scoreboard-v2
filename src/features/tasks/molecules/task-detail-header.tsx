...
export function TaskDetailHeader({ headerData, actions, notificationsOpen, onToggleNotifications, onOpenNotification, onDismissNotification, onBack, backLabel = "Zur Planung" }: Props) {
  return (
