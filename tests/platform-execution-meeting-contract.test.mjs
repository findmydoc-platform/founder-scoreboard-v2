...
test("execution layer keeps focus board and hygiene alerts without decision links", async () => {
  ...
  assert.doesNotMatch(executionUi, /Decision-Link entfernen|Decision-Folgearbeit|Folgeaufgabe aus Decision/);
  ...
  assert.doesNotMatch(panelContext, /Begründende Decisions/);
  assert.match(panelContext, /Fokus-Kontext/);
  assert.match(detail, /TaskContextSection/);
  assert.doesNotMatch(taskContext, /Begründende Decisions/);
