...
- Do not use `AGENTS.md` or `SKILL.md` prose, source text, file layout, removed behavior, pipeline implementation, or script internals as test oracles.
...
- Never connect tests to production services. Use real UTF-8 for German fixtures.
