...
test("github oauth prepares user-based sync without storing provider tokens", async () => {
  ...
  assert.match(detailGitHubSyncCard, /GitHub-Rechte erneuern/);
  assert.match(readinessUi, /Sync, Kommentare und Anhänge/);
  assert.match(detailGitHubSyncCard, /Sync, Kommentare und Anhänge/);
