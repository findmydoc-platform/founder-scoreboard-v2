...
test("stale revisions and every injected local write failure leave no partial state", async (t) => {
  ...
  for (const step of ["item", "activity", "audit", "notification", "projection"]) {
