...
comment on function public.move_backlog_task_transaction(text, text, text, timestamptz, timestamptz, text, text, text)
  is 'Atomically moves one active backlog Deliverable relative to another with compare-and-set timestamps, authoritative actor validation, and an audit record.';

revoke all on function public.move_backlog_task_transaction(text, text, text, timestamptz, timestamptz, text, text, text) from public, anon, authenticated;
