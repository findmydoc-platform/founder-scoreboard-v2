...
- Use `.agents/skills/fmd-story-writing` when creating, reviewing, restructuring, or syncing tasks, stories, deliverables, sub-issues, GitHub issue bodies, task templates, or Acceptance Criteria. Do not silently rewrite approved, reviewed, released, or GitHub-synced stories; content changes need explicit approval or a revision/follow-up comment.
