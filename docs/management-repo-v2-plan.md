...
| `.github/ISSUE_TEMPLATE/group-commitment.yml` | Sprint-übergreifender Team-Meilenstein | Begrifflich nah an v2, aber verwechselt Meilenstein und Group Commitment | Durch v2-Group-Commitment-Template ersetzen |
...
- `docs/management-templates-v2/group-commitment.yml`
...
3. `group-commitment.yml` ersetzen durch v2.
